...
import com.qiyuzhibo.phonelive.interf.OnItemClickListener;
...
public class NearAdapter extends RecyclerView.Adapter {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(ActiveBean item) {
            ...
            Glide.with(mContext).load(item.getThumb()).placeholder(R.drawable.live_show_login_bg).into(urlImageView);
            mDisTance.setText(item.getLikes());
