...
import com.qiyuzhibo.phonelive.bean.GiftBean;
import com.qiyuzhibo.phonelive.bean.UserBean;
import com.qiyuzhibo.phonelive.event.AttentEvent;
...
public class PhoneLiveApi {
    ...
    public static void createLive(String uid, String a1, String a2, String title, String token, String name, File file, String type, String type_val, StringCallback callback) {
        try {
            ...
            Log.i("AQQQQQQQ",AppConfig.MAIN_URL_API+"Live.creatRoom"+uid+""+title+""+name+""+a1+""+a2+""+AppContext.address+""+AppContext.province+""+AppContext.lat+""+AppContext.lng+""+token+""+type+""+type_val+"");
            if (file != null) {
    ...
    public static void sendGift(UserBean mUser, GiftBean g, String mNowRoomNum, String stream, StringCallback callback) {
        OkHttpUtils.get()
                ...
                .build()
                .execute(callback);
        Log.i("AAASADWADA", AppConfig.MAIN_URL_API+""+"Live.sendGift"+"token"+mUser.token+"uid"+""+(mUser.id)+""+String.valueOf(mNowRoomNum)+""+String.valueOf(g.getId())+""+1+""+stream+""+"sendGift");
    }
     ...
     * @dw TAB
     */
    public static void getTab(StringCallback callback) {

        //HHH 2016-09-09
        OkHttpUtils.get()
                .url(AppConfig.MAIN_URL_API)
                .addParams("service", "Movie.GetCatList")
                .addParams("p", "1")
                .addParams("limit", "10")
                .tag("GetCatList")
                .build()
    ...
    public static void getVideo(int p,StringCallback callback) {
        ...
        OkHttpUtils.get()
                ...
                .build()
                .execute(callback);
        Log.i("QAQAQ", AppConfig.MAIN_URL_API+"service="+"Video.getVideoList"+"uid="+AppContext.getInstance().getLoginUid()+"p="+String.valueOf(p)+"getVideoList");
    }
    /**
     * @dw 获取小视频分类
     */
    public static void getVideo1(int p,int caid,String token,StringCallback callback) {

        //HHH 2016-09-09
        OkHttpUtils.get()
                .url(AppConfig.MAIN_URL_API)
                .addParams("service", "Movie.GetMovieList")
                .addParams("cat_id", String.valueOf(caid))
                .addParams("uid", AppContext.getInstance().getLoginUid())
                .addParams("token", token)
                .addParams("p", String.valueOf(p))
                .addParams("limit", "6")
     ...
     * @dw 获取小视频推荐
     */
    public static void getVideohome(int p ,String token,StringCallback callback) {

        //HHH 2016-09-09
        OkHttpUtils.get()
                .url(AppConfig.MAIN_URL_API)
                .addParams("service", "Movie.GetRecommendMovieList")
                .addParams("uid", AppContext.getInstance().getLoginUid())
                .addParams("token", token)
                .addParams("p", String.valueOf(p))
                .addParams("limit", "10")
     ...
     * @dw CocoPay下订单
     */
    public static void getCocoPayOrderNum(String uid, String changeid, String num, String money,int type, StringCallback callback) {
        OkHttpUtils.get()
                .url(AppConfig.MAIN_URL_API)
                .addParams("service", "Charge.getCocopayOrder")
                .addParams("uid", uid)
                .addParams("money", money)
                .addParams("changeid", changeid)
                .addParams("coin", num)
                .addParams("type",type+"")
                .tag("getCocoPayOrderNum")
                .build()
                .execute(callback);
    }
    ...
    //获取视频地址的接口
    public static void getVideoURL(String uid, String token, File protraitFile, StringCallback callback) {
        OkHttpUtils.post()
                .url(AppConfig.MAIN_URL_API)
                .addParams("service", "File.UploadVideo")
                .addFile("file", "sp.mp4", protraitFile)
                .addParams("uid", uid)
                .addParams("token", token)
                //.url(AppConfig.MAIN_URL_API + "appapi/?service=User.upload")
                .tag("phonelive")
    ...
    //获取视频地址的接口
    public static void getVideoImgURL(String uid, String token, File protraitFile, StringCallback callback) {
        OkHttpUtils.post()
                .url(AppConfig.MAIN_URL_API)
                .addParams("service", "File.UploadVideoImg")
                .addFile("file", "fm.png", protraitFile)
                .addParams("uid", uid)
                .addParams("token", token)
                //.url(AppConfig.MAIN_URL_API + "appapi/?service=User.upload")
                .tag("phonelive")
