package com.qiyuzhibo.phonelive.base;
...
import com.qiyuzhibo.phonelive.adapter.ChatListAdapter;
import com.qiyuzhibo.phonelive.adapter.UserListAdapter;
...
import com.qiyuzhibo.phonelive.bean.SimpleUserInfo;
import com.qiyuzhibo.phonelive.bean.UserBean;
import com.qiyuzhibo.phonelive.event.ChatExitEvent;
import com.qiyuzhibo.phonelive.fragment.LiveEmceeEndFragmentDialog;
import com.qiyuzhibo.phonelive.fragment.LiveEndFragmentDialog;
import com.qiyuzhibo.phonelive.fragment.MessageFragment;
import com.qiyuzhibo.phonelive.fragment.UserInfoDialogFragment;
import com.qiyuzhibo.phonelive.model.Danmu;
import com.qiyuzhibo.phonelive.ui.customviews.ErrorDialogFragment;
import com.qiyuzhibo.phonelive.ui.other.ChatServer;
import com.qiyuzhibo.phonelive.ui.other.DrawableRes;
import com.qiyuzhibo.phonelive.utils.InputMethodUtils;
import com.qiyuzhibo.phonelive.utils.LiveUtils;
import com.qiyuzhibo.phonelive.utils.ShareUtils;
import com.qiyuzhibo.phonelive.utils.StringUtils;
import com.qiyuzhibo.phonelive.utils.TDevice;
...
import com.qiyuzhibo.phonelive.widget.MyAnimationDrawable;
import com.qiyuzhibo.phonelive.widget.SpaceRecycleView;
import com.qiyuzhibo.phonelive.widget.VerticalImageSpan;
import com.qiyuzhibo.phonelive.widget.danmu.DanmuControl;
...
//
        mGiftView = getLayoutInflater().inflate(R.layout.svga_layout, null);

        sVGAImageView = (SVGAImageView) mGiftView.findViewById(R.id.sVGAImageView);
        ...
        try {
            parser.decodeFromURL(new URL(mSendGiftBean.getSvg()), new SVGAParser.ParseCompletion() {
                @Override
...
//        });
    ...
    private void startJoinRoomAnimation() {
        ...
        if (!("0").equals(user.car_id)) {
            ...
            SVGAParser parser = new SVGAParser(this);
            try {
                parser.decodeFromAssets(user.car_id+".svga", new SVGAParser.ParseCompletion() {
                    @Override
            ...
            sVGAImageView.setCallback(new SVGACallback() {
                ...
                public void onFinished() {
                    ...
                    if (null != mGiftView) {
                        if (null != mRlLiveGift && mRlLiveGift.getChildCount()>0) {
