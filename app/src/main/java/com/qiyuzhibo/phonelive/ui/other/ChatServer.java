package com.qiyuzhibo.phonelive.ui.other;
...
public class ChatServer {
        ...
        public void call(Object... args) {
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    TLog.error("222:"+ jsonArray.getString(i));
    ...
    private void onMessage(SocketMsgUtils msgUtils) throws JSONException {
        ...
        if ((!touid.equals("0") && (touid.equals(AppContext.getInstance().getLoginUid())))) {
            ...
            name.setSpan(new ForegroundColorSpan(Color.parseColor("#ffffff")), uname.length(), name.length(),
                    Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
        //判断是否是点亮
