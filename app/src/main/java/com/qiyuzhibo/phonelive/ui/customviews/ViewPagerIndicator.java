package com.qiyuzhibo.phonelive.ui.customviews;
...
public class ViewPagerIndicator extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs) {
        ...
        mNormalColor = a.getColor(R.styleable.ViewPagerIndicator_normalColor, Color.YELLOW);
        mLightColor = a.getColor(R.styleable.ViewPagerIndicator_lightColor, Color.YELLOW);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mDrawTriangle) {//画三角形
            canvas.drawRect(x1 + dp2px(8), -dp2px(10), x1 + w / 2, y2 , mTrianglePaint);
            canvas.drawRect(x1 + w / 2, y2 , x2 - dp2px(8), -dp2px(10), mTrianglePaint);
        } else {
            //画出矩形
