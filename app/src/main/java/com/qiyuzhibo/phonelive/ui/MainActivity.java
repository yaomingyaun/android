...
import com.qiyuzhibo.phonelive.bean.BonusBean;
import com.qiyuzhibo.phonelive.bean.UserBean;
import com.qiyuzhibo.phonelive.event.ChatExitEvent;
import com.qiyuzhibo.phonelive.event.CoinNameEvent;
import com.qiyuzhibo.phonelive.fragment.GuanzhuFragment;
import com.qiyuzhibo.phonelive.fragment.HH;
import com.qiyuzhibo.phonelive.fragment.HomeFragment;
import com.qiyuzhibo.phonelive.fragment.LoginAwardDialogFragment;
import com.qiyuzhibo.phonelive.fragment.MessageFragment;
import com.qiyuzhibo.phonelive.fragment.PublisherDialogFragment;
import com.qiyuzhibo.phonelive.fragment.UserInformationFragment;
import com.qiyuzhibo.phonelive.fragment.VideoFargment2;
import com.qiyuzhibo.phonelive.fragment.VideoFragment;
import com.qiyuzhibo.phonelive.fragment.ZhiBoFragment;
import com.qiyuzhibo.phonelive.ui.dialog.LiveCommon;
import com.qiyuzhibo.phonelive.utils.LocationUtil;
import com.qiyuzhibo.phonelive.utils.LoginUtils;
import com.qiyuzhibo.phonelive.utils.SharedPreUtil;
...
import com.qiyuzhibo.phonelive.utils.UpdateManager;
import com.qiyuzhibo.phonelive.widget.LineEditText;
import com.qiyuzhibo.phonelive.widget.PwdEditText;
...
public class MainActivity extends AppCompatActivity implements LoginAwardDialogFragment.onLoginAwardImgShow {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState==null){
            videoFargment2 = new VideoFargment2();
            //关注替换为直播
        ...
        //    videoFragment=new VideoFragment();
            ...
            ft.add(R.id.replaced, videoFargment2);
            ft.add(R.id.replaced, zhiBoFragment);
            ft.add(R.id.replaced, mMessageFragment);
            ft.add(R.id.replaced, mUserFragment);
            ft.show(videoFargment2).hide(zhiBoFragment).hide(mMessageFragment).hide(mUserFragment).commit();
            //首页与直播互换位置
            mSparseArray = new SparseArray<>();
            mSparseArray.put(0,videoFargment2 );
            mSparseArray.put(1, zhiBoFragment);
